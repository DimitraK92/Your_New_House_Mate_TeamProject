...
namespace YNHM.WebApp.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Views/Administrator/People/Index",people);
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            return View("~/Views/Administrator/People/Details",person);
        }

        // GET: People/Create
        public ActionResult Create()
        {
            return View("~/Views/Administrator/People/Create");
        }
        ...
        public ActionResult Create([Bind(Include = "PersonId,FirstName,LastName,Age,MatchPercent,Phone,Email,Facebook,Description,PhotoUrl")] Person person)
        {
            ...
            return View("~/Views/Administrator/People/Create",person);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            return View("~/Views/Administrator/People/Edit",person);
        }
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return View("~/Views/Administrator/People/Delete",person);
        }
